...
#define BOARD_SCOPE_TRIGGER_GPIO GPIOA               /*!<@brief GPIO peripheral base pointer */
#define BOARD_SCOPE_TRIGGER_GPIO_PIN_MASK (1U << 1U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_SCOPE_TRIGGER_PORT PORTA               /*!<@brief PORT peripheral base pointer */
#define BOARD_SCOPE_TRIGGER_PIN 1U                   /*!<@brief PORT pin number */
